...
<div class="content">
  ...
  <div class="metrics">
    ...
    <div class="metric">
      <div class="value">~300KB</div>
      <div class="label">Min Binary</div>
    </div>
    <div class="metric">
  ...
  <!-- Architecture -->
  <section class="section" data-label="architecture">
    <h2>System Design</h2>
    <div class="arch-diagram"><span class="highlight">PID 1:</span> /app/shim
...
<span class="highlight">Capabilities:</span>
  ...
  <!-- Shim Catalog -->
  <section class="section" data-label="catalog">
    <h2>Shim Catalog</h2>
    <div class="grid">
      <div class="grid-item">
        <h3>health-shim</h3>
  ...
  <!-- Quick Start -->
  <section class="section" data-label="quickstart">
    <h2>Quick Start</h2>
...
cargo build --release \
  ...
  <!-- Binary Matrix -->
  <section class="section" data-label="binaries">
